...
const AccessSectionTwo: React.FC = () => {
    return (
        <AccessSection>
            <AccessWrapper>
                <SectionTitleTwo
                ...
                <AccessContent>
                    ...
                    <AccessInfoContainer>
                        <AccessCategory>
                            ...
                            <AccessItem>
                                <TransportIcon>XR線</TransportIcon>
                                <AccessDetails>
                                    <StationName>「XX駅」南口より徒歩10分</StationName>
                                    <AccessTime>山手線・京浜東北線が利用可能です。</AccessTime>
                                </AccessDetails>
                            </AccessItem>
                            <AccessItem>
                                <TransportIcon>AR線</TransportIcon>
                                <AccessDetails>
                                    <StationName>「XX駅」西口より徒歩8分</StationName>
                                    <AccessTime>山手線・京浜東北線が利用可能です。</AccessTime>
                                </AccessDetails>
                            </AccessItem>
                        </AccessCategory>
                        <AccessCategory>
                            ...
                            <AccessItem>
                                <TransportIcon>市バス</TransportIcon>
                                <AccessDetails>
                                    <StationName>「XX駅」西口より徒歩9分</StationName>
                                    <AccessTime>JR「XX駅」東口バスターミナル3番乗り場よりお乗りください。</AccessTime>
                                </AccessDetails>
                            </AccessItem>
                        </AccessCategory>
                    </AccessInfoContainer>
...
export default AccessSectionTwo;